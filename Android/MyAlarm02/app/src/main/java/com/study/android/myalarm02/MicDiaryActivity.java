...
public class MicDiaryActivity extends AppCompatActivity
        implements RecognitionListener
{
    private static final String TAG = "lecture";

    private static final int REQUEST_CODE = 1000;
    TextView textView1; // 말한 내용을 저장하는 영역

    DatePicker datePicker;
    TextView viewDate;  //  viewDate- 선택한 날짜를 보여주는 영역
    EditText edtDiary;   // 기존 내용을 수정하는 영역
    ...
    protected void onCreate(Bundle savedInstanceState) { // 앱 첫 시작 시 돌아가는 메소드
        ...
        viewDate = (TextView) findViewById(R.id.viewDatePick);
