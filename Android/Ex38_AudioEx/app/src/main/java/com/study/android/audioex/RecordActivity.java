...
public class RecordActivity extends AppCompatActivity {
    ...
    public void onBtn1Clicked(View v) {
       ...
       try {
           Toast.makeText(getApplicationContext(), "녹음을 시작하지",
    ...
    public void onBtn2Clicked(View v) {
        if(recorder != null)
            ...
            Toast.makeText(getApplicationContext(), "녹음을 중지하지",
                    Toast.LENGTH_LONG).show();
        }
    ...
    public void onBtn3Clicked(View v) {
        if (player != null) {
            ...
            Toast.makeText(getApplicationContext(), "녹음된 파일을 재생하지",
                    Toast.LENGTH_LONG).show();
        }
    ...
    public void onBtn4Clicked(View v) {
        ...
        Toast.makeText(getApplicationContext(), "재생이 중지되었다.",
                Toast.LENGTH_LONG).show();
